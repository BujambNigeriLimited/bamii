                    ...
                    <div id="page-content">
                        <section class="container">
                            <div class="block">
                                <div class="row">
                                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3" style="background-color: #eee;">
                                        <header>
                                        ...
                                        <form role="form" id="form-sign-in-account" method="post" action="?">
                                            ...
                                            <div class="form-group clearfix">
                                                <button type="submit" class="btn pull-right btn" id="account-submit">Sign In</button>
                                            </div><!-- /.form-group -->
                                        </form>
                                    </div>
                                </div>
