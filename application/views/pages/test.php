...
foreach ($newArray as $key => $value) {
    ...
    foreach ($value as $final_value) {
        echo $final_value['pictures']."<br/>"; // print all items against category
    }
}
?>
<div id="page-content">
    <section class="container">
        <div class="row">
            ...
            <div class="col-md-9" style="top: 60px;">
                ...
                <?= validation_errors(); ?>
                <?=form_open_multipart(site_url('pages/test')); ?>
                    <section>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control" id="country" onchange="set_states(this,state,city)" name="country">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select type="text" disabled="disabled" onchange="set_city(this,city)" class="form-control" id="state" name="state">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select type="text" disabled="disabled" onchange="print_city(state,this)" class="form-control" id="city" name="city">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                ...
                <?=form_close();?>
                <!--/#form-submit-->
                <div id="txtcountry" style="display: none"></div>
